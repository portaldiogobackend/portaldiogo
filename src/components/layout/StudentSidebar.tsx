...
export const StudentSidebar: React.FC<StudentSidebarProps> = ({
  ...
  const menuItems = [
    ...
    { id: 'dissertativas', label: 'Questões Dissertativas', icon: FileText, path: '/aluno/envio-dissertativas' },
    ...
    <div className=''>
      ...
      <div className={`mt-auto ${isCollapsed ? 'px-4' : 'px-6'} pb-8 space-y-4 overflow-hidden flex-shrink-0`}>
        ...
        >
          ...
          {!isCollapsed && <span className="text-[15px] whitespace-nowrap">Sair</span>}
        </button>
      </div>
    </aside>
    </div>
